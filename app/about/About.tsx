    ...
    <div className="text-black dark:text-white">
      ...
      <div className="w-[95%] 800px:w-[85%] m-auto">
        ...
        Are you ready to transform your learning experience? Look no further than 1SHOT - LMS, the premier online learning platform designed to address the challenges of today's eLearning landscape for both educators and learners.
          ...
          That&apos;s why we created 1SHOT &ndash; to provide a space where education is accessible, engaging, and empowering for everyone.
          <br />
          <br />
          ...
          <br />
          <br />
          At 1SHOT &ndash; LMS, we are more than just a platform; we are a community of passionate learners and educators. Whether you’re looking to enhance your skills or share your knowledge with others, 1SHOT is here to support you every step of the way.
          <br />
          <br />
          So, what are you waiting for? Join the 1SHOT community today, and let’s reshape the future of education together. With our affordable courses and collaborative environment, the possibilities for your learning journey are limitless!
          <br />
          <br />
        </p>
        <br />
